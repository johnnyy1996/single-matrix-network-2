...
public:
	...
	void Network::printNetworkSquashedOutputState(void); // 11/11/2016
	...
	void Network::writeNetworkOutputStateToFile(char * file_name, int currentCylce);// Added by Roberto Coyotl
